...
[time1, vc_alpha1, vc_beta1, if_alpha1, if_beta1, R1, x_opt_old1]=ndgrid(time, vc_alpha, vc_beta, if_alpha, if_beta, R, x_opt_old); % Create grid
...
save('dataANNcrd.mat', 'if_alpha1', 'if_beta1', 'vc_alpha1', 'vc_beta1' ,'vref_beta1','vref_alpha1', 'x_opt_old1', 'x_opt', 'vector', 'R1')
