...
model.add(tf.keras.layers.Dense(15, activation='relu', input_dim = 9))   #Add layer with 8 neurons and relu activation. Other activations found at https://keras.io/activations/
