...
#Note the use of loc which allows us to pull out columns based on original location, since we don't have a header row in this data set.
# =============================================================================
...
# =============================================================================
# Now, let's parse out the labels and features and look at a few examples.
# =============================================================================
...
# =============================================================================
# Here, we'll make separate input functions for training and for prediction. We'll nest them in create_training_input_fn() and create_predict_input_fn(), respectively, so we can invoke these functions to return the corresponding _input_fns to pass to our .train() and .predict() calls.
# =============================================================================
...
# =============================================================================
#load the test data (new data) and separate labels and features with parse function
