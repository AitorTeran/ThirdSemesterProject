...
model.add(tf.keras.layers.Dense(15, activation='sigmoid', input_dim = 8))   #Add layer with 8 neurons and relu activation. Other activations found at https://keras.io/activations/
